...
competitively, beating the CNN baseline on NIFTY). \textbf{Next steps}: the Scheme-B confirmatory training;
multi-seed bootstrap confidence intervals; the cost-aware backtest; a walk-forward robustness check; and
consolidation of all results into the final report.
