...
(Section~3.6) remains the key \emph{economic} finding. \emph{(Single seed, NIFTY; multi-seed CIs are deferred
...
\end{tabular}
\end{table}
\textbf{Honest verdict: an efficiency result, not an accuracy win.} TLOB still leads weighted \emph{and}
...
both instruments, four horizons). Deferred (next phase): Scheme-B confirmatory training, multi-seed
confidence intervals, and the cost-aware backtest.
