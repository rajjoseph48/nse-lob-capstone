...
\noindent\emph{(B) Improved MambaLOB architecture (the headline novelty).} Move beyond the vanilla SSM stack
to (i) \textbf{bidirectional Mamba} (forward + time-reversed scans concatenated --- valid for
classification, the BiLSTM analog) and (ii) \textbf{ConvMambaLOB}, a hybrid that prepends DeepLOB-style
convolutions (spatial LOB structure) to the linear-time Mamba temporal core. Goal: match or beat TLOB at a
