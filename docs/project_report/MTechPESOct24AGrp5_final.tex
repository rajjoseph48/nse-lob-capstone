...
% (b) bidirectional
\node[io, below=8mm of a0] (b0) {Input};
...
\node[below=0.5mm of b2, font=\scriptsize, text width=24mm, align=center] {fwd + reversed\\scan, averaged};
% (c) conv
\node[io, below=14mm of b0] (c0) {Input};
...
% (d) both
\node[io, below=8mm of c0] (e0) {Input};
