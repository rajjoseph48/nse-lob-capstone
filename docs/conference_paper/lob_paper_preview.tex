...
\usepackage{amsmath,amssymb,booktabs,graphicx,color}
\usepackage{tikz}\usetikzlibrary{arrows.meta,positioning}
\usepackage[hidelinks]{hyperref}\usepackage{abstract}
\title{\textbf{Stock Market Index Direction Prediction Using Limit Order Book Data}\\[2pt]\large\normalfont EAI format --- CONTENT PREVIEW (final PDF: Overleaf pdfLaTeX)}
\author{Joseph Raj, Sumanth G. M, Abhishek Kumar, Kumara Swamy, Raghav, Saagar\\ \small Dept. of Data Science, ML \& AI, PES University, Bengaluru, India}\date{}
...
\smallskip\noindent\textbf{Keywords:} Limit Order Book, Mid-price Prediction, State-Space Models, Mamba, Market Microstructure, NSE Index Futures, Deep Learning, Data Engineering\end{onecolabstract}\bigskip]
